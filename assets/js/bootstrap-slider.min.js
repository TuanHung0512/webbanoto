        ...
        d.prototype = {
            ...
            _layout: function() {
                ...
                this.rangeHighlightElements.length > 0 && Array.isArray(this.options.rangeHighlights) && this.options.rangeHighlights.length > 0)
                    for (var b = 0; b < this.options.rangeHighlights.length; b++) {
                        ...
                        this.rangeHighlightElements[b].style.height = f.size + "%") : (this.rangeHighlightElements[b].style.left = f.start + "%",
                ...
                if (Array.isArray(this.options.ticks) && this.options.ticks.length > 0) {
                    ...
                    if (this.tickLabelContainer) {
                        ...
                        if (0 === this.options.ticks_positions.length)
                            "vertical" !== this.options.orientation && (this.tickLabelContainer.style[h] = -i / 2 + "px"),
                    ...
                    for (var k = 0; k < this.options.ticks.length; k++) {
                        ...
                        this.tickLabels[k] && (this.tickLabels[k].style[g] = i + "px",
                        ...
                        this.tickLabels[k].style[h] = -i / 2 + "px") : "vertical" === this.options.orientation && (this.tickLabels[k].style.marginLeft = this.sliderElem.offsetWidth + "px",
            ...
            _keydown: function(a, b) {
                ...
                if (c) {
                    ...
                    return this.options.range && (f = [a ? this._state.value[0] : f, a ? f : this._state.value[1]]),
