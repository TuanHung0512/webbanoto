...
<title>KHO SIÊU XE HIỆN CÓ</title>
<!--Bootstrap -->
...
$cnt=$query->rowCount();
?>
<p><span><?php echo htmlentities($cnt);?>  SIÊU XE</span></p>
</div>
</div>
...
{  ?>
        <div class="product-listing-m gray-bg">
          ...
          <div class="product-listing-content">
            ...
            <p class="list-price"><?php echo htmlentities($result->PricePerDay);?> VNĐ</p>
            <ul>
...
<?php }} ?>
              ...
              <option>Loại nguyên liệu</option>
...
{  ?>
              ...
              <li class="gray-bg">
                ...
                <div class="recent_post_title"> <a href="vehical-details.php?vhid=<?php echo htmlentities($result->id);?>"><?php echo htmlentities($result->BrandName);?> , <?php echo htmlentities($result->VehiclesTitle);?></a>
                  <p class="widget_price"><?php echo htmlentities($result->PricePerDay);?> VNĐ</p>
                </div>
              </li>
              <?php }} ?>
