...
<div class="modal fade" id="forgotpassword">
  ...
  <div class="form-group">
                ...
                <div class="form-group">
                  <input type="submit" value="Thay đổi mật khẩu" name="update" class="btn btn-block">
                </div>
              </form>
              <div class="text-center">
                <p class="gray_text">Vì lý do tránh để quên nữa thì tôi khuyên bạn hãy note ra giấy đi và đừng chia sẻ mật khẩu cho ai.</p>
                <p><a href="#loginform" data-toggle="modal" data-dismiss="modal"><i class="fa fa-angle-double-left" aria-hidden="true"></i> Đăng Nhập Lại</a></p>
              </div>
            </div>
          </div>
        </div>
