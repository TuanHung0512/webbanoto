      ...
      <div class="row">
        <div class="col-md-5 col-md-push-7">
          <div class="banner_content">
            <h1>Kho Xe Của Nhóm 8 vip.</h1>
            <p>Xe Không Chất Hoàn Tiền Gấp 2. </p>
            <a href="#" class="btn">Trang Chủ<span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></a> </div>
        </div>
      </div>
    </div>
  </div>
...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      <h2> Where Speed <span>Meets Luxury</span></h2>
      <p>KHO SIÊU XE CỦA NHÓM CHÚNG TÔI: là thiên đường dành cho những tín đồ đam mê tốc độ và đẳng cấp! Chúng tôi mang đến bộ sưu tập siêu xe sang trọng, hiệu suất vượt trội từ các thương hiệu danh tiếng hàng đầu thế giới. Với sự uy tín, chất lượng và dịch vụ chuyên nghiệp, Kho Siêu Xe Nhóm 8 cam kết mang đến cho bạn những trải nghiệm lái xe đỉnh cao, khẳng định phong cách và đẳng cấp xứng tầm!</p>
    </div>
    <div class="row"> 
      ...
      <div class="recent-tab">
        <ul class="nav nav-tabs" role="tablist">
          <li role="presentation" class="active"><a href="#resentnewcar" role="tab" data-toggle="tab">Xe hiện có</a></li>
        </ul>
      </div>
...
<span class="price"><?php echo htmlentities($result->PricePerDay);?> vnđ</span> 
</div>
  ...
  <div class="container div_zindex">
    <div class="row">
      ...
      <div class="col-lg-3 col-xs-6 col-sm-3">
        <div class="fun-facts-m">
          <div class="cell">
            <h2><i class="fa fa-car" aria-hidden="true"></i>2020+</h2>
            <p>Xe cũ bán lại</p>
          </div>
        </div>
      </div>
...
<section class="section-padding testimonial-section parallex-bg">
  <div class="container div_zindex">
    <div class="section-header white-text text-center">
      <h2>Khách Hàng <span>LÀ THƯỢNG ĐẾ</span></h2>
    </div>
    <div class="row">
