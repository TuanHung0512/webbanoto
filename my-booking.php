    ...
    <div class="row">
      ...
      <div class="col-md-6 col-sm-8">
        <div class="profile_wrap">
          <h5 class="uppercase underline">GIỎ HÀNG </h5>
...
<li>
                ...
                <div class="vehicle_title">
                  ...
                  <p><b>Ngày đặt mua xe:</b> <?php echo htmlentities($result->FromDate);?><br /> <b>Ngày nhận xe:</b> <?php echo htmlentities($result->ToDate);?></p>
                </div>
                <?php if($result->Status==1)
                { ?>
                <div class="vehicle_status"> <a href="#" class="btn outline btn-xs active-btn">THÀNH CÔNG</a>
                           <div class="clearfix"></div>
        </div>

              <?php } else if($result->Status==2) { ?>
 <div class="vehicle_status"> <a href="#" class="btn outline btn-xs">THẤT BẠI</a>
            <div class="clearfix"></div>
        </div>
                ...
                <?php } else { ?>
 <div class="vehicle_status"> <a href="#" class="btn outline btn-xs">Chờ xác nhận</a>
            <div class="clearfix"></div>
        </div>
                <?php } ?>
