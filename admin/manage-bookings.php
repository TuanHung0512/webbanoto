								...
								<table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
									<thead>
										...
										<th>#</th>
											...
											<th>Siêu xe</th>
											<th>Ngày đặt xe</th>
											<th>Ngày mong muốn nhận xe</th>
											<th>Tin nhắn</th>
											<th>Tình trạng</th>
											<th>Ngày nhận đơn xe</th>
											<th>Chi tiết</th>
										</tr>
									</thead>
									<tfoot>
...
echo htmlentities('Thành công');
}
 else{
 	echo htmlentities('Bị hủy');
 }
										?></td>
											<td><?php echo htmlentities($result->PostingDate);?></td>
										<td><a href="manage-bookings.php?aeid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Xác nhận đơn mua xe này')"> Xác nhận</a> /


<a href="manage-bookings.php?eid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Hủy đơn mua xe này')"> Hủy</a>
</td>
