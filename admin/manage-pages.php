...
<head>
	...
	<title>Cập nhật chính xác</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Cập nhật chính sách </h2>

						<div class="row">
							<div class="col-md-10">
								<div class="panel panel-default">
									<div class="panel-heading">Danh sách các chính sách</div>
                  ...
                  <option value="manage-pages.php?type=terms">Các điều khoản</option>
                  <option value="manage-pages.php?type=privacy">Các chính sách</option>
                  <option value="manage-pages.php?type=aboutus">Về nhóm chúng tôi</option> 
